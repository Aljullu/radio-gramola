...
<div id="wrapper">
	...
	<div id="video">
		<iframe width="<?php echo $width; ?>" height="<?php echo $height; ?>" src="http://www.youtube.com/embed/<?php echo $canco['codi']; ?>?autoplay=1&controls=<?php echo $controls; ?>&start=<?php echo $segonsqueportalacanco; ?>" frameborder="0" allowfullscreen></iframe>
	</div>
	<div>
